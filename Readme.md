...
2. Delete the default *Camel* route generated my *Maven*, and include the Camel route definition that will execute the mapping.
   ...
   ```
    ...
    __**Please note**__ how the Red Hat VSCode extensions can help you building your code using auto-completion as you type your Camel XML DSL: \
